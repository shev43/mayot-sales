...
const dict = {
  uk: {
    ...
    sketch: "Ескіз архітекторів", roads: "Існуючі дороги", s1a: "Stage 1A", s2: "Stage 2", parking: "Паркінг (X-ray)",
    water: "Вода", trees: "Ліс",
    cameras: "Камери",
    Overview: "Огляд", Top: "Зверху", S1A: "S1A", S2: "S2", S3: "S3", Entrance: "В'їзд",
  ...
  en: {
    ...
    sketch: "Architects' sketch", roads: "Existing roads", s1a: "Stage 1A", s2: "Stage 2", parking: "Parking (X-ray)",
    water: "Water", trees: "Forest",
    cameras: "Cameras",
    Overview: "Overview", Top: "Top", S1A: "S1A", S2: "S2", S3: "S3", Entrance: "Entrance",
    calibrate: "Calibrate",
